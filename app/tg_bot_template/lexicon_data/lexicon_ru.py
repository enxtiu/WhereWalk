...
9. Редактировать - удаление мест""",
    ...
    'not_back': 'Назад листать некуда',
    'not_next': 'Пока это все доступные заведения',
    'not_fav': 'К сожалению у вас ещё нету избранных, чтоб добавить нажмите на ❤️ в нужном виджете',
    'add_f': 'Место успешно добавлено',
    'nots': 'Вот ваши сохранённые места👇\nПри нажатие откроется виджет с заведением, а так же вы можете отредактировать удалив не нужные)',
    'del_nots': 'Нажмите на те заведения которые хотели бы удалить👇',
    'er_del':'Произошла ошибка, место не удалено'
}

def widget(*args) -> str:
    result = f"""Название места: {args[0]}
<b>Описание места</b>: {args[1]}
⭐ <b>Рейтинг на yandex map</b>: {args[2]} <a href="{args[7]}">Подробнее</a>
📍 <b>Адрес</b>: {args[3]}
Часы работы: {args[5]}
Контакты: {args[4]}
"""

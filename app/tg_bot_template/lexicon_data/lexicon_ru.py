...
ps: К сожалению некоторый функционал ещё не доступен, поэтому он будет перечёркнут, но я надеюсь, что в скором времени он будет доступен) """,
    'menu_des': {
    'description': '<b>Описание возможностей бота</b>',
    'author': '<b>Тех-поддержка</b>',
    'politic': '<b>Политика конфиденциальности</b>',
    'favourites': '<b>Избранные заведения</b>'},
...
def widget_ru(*args) -> str:
    result = f"""Название места: {args[0]}
<b>Описание места<b>: {args[1]}
⭐ <b>Рейтинг на yandex map<b>: рейтинг - <a href={args[2]}>Подробнее про отзывы</a>
📍 <b>Адрес<b>: {args[3]}
Часы работы: {args[4]}
Контакты: {args[5]}
<a href={args[6]}>Подробнее</a>"""
    return result
